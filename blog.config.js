...
const BLOG = {
  AUTHOR: 'veeveesue', // 作者
  BIO: '干饭人', // 作者简介
  LINK: 'https://blog.wyy.moe', // 网站地址
  KEYWORDS: 'Notion, 博客, 测试, 管理', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'e678e3f48193455ebba37b83988afff3', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'veeveesue@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/veeveesue', // 你的github个人主页
